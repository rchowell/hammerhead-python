...
from ...types.workouts import file_create_params, file_update_params
from ...types.workouts.workout import Workout
...
class FileResource(SyncAPIResource):
    ...
    def create(
        ...
        *,
        ...
        Date the workout is planned to be done. Format is YYYY-MM-DD

          file: A workout file. Filename should have one of the following extensions: .fit .zwo
        ...
        return self._post(
            ...
            options=make_request_options(
                ...
                timeout=timeout,
                query=maybe_transform({"planned_date": planned_date}, file_create_params.FileCreateParams),
            ),
            cast_to=Workout,
        )
    ...
    def update(
        ...
        *,
        ...
        extra_headers = {"Content-Type": "multipart/form-data", **(extra_headers or {})}
        return self._put(
            path_template("/workouts/{workout_id}/file", workout_id=workout_id),
            ...
            options=make_request_options(
                ...
                extra_body=extra_body,
                timeout=timeout,
                query=maybe_transform({"planned_date": planned_date}, file_update_params.FileUpdateParams),
            ),
            cast_to=Workout,
        )
        ...
        *,
        ...
        return await self._post(
            ...
            options=make_request_options(
                ...
                extra_body=extra_body,
                timeout=timeout,
                query=await async_maybe_transform({"planned_date": planned_date}, file_create_params.FileCreateParams),
            ),
            cast_to=Workout,
        )
        ...
        *,
        ...
        return await self._put(
            ...
            options=make_request_options(
                ...
                extra_body=extra_body,
                timeout=timeout,
                query=await async_maybe_transform({"planned_date": planned_date}, file_update_params.FileUpdateParams),
            ),
            cast_to=Workout,
        )
